...
const sections = [
  ...
  { href: "/admin/cms/pages", label: "Pages", icon: FileText, desc: "Static pages and policy content" },
  { href: "/admin/cms/footer", label: "Footer", icon: MapPin, desc: "Footer content and information blocks" },
  { href: "/admin/cms/menus", label: "Menus", icon: Tag, desc: "Navigation menus and links" },
  { href: "/admin/cms/banners", label: "Banners", icon: Image, desc: "Promotional banners and campaign visuals" },
  { href: "/admin/careers", label: "Careers", icon: BriefcaseBusiness, desc: "Job listings and career page" },
]

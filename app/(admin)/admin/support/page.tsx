...
const sections = [
  { href: "/admin/support/messages", label: "Contact Messages", icon: MessageSquare, desc: "Customer inquiries and contact form submissions" },
  { href: "/admin/support/tickets", label: "Support Tickets", icon: Ticket, desc: "Formal support requests and issue tracking" },
]
